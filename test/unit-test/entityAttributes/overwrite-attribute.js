...
describe('Overwrite Single Entity Attribute', function () {
    beforeEach((done) => {
        nock.cleanAll();
        lepus.start(config, () => {
            done();
    ...
    describe('When a normalized property is overwritten by name', function () {
        beforeEach(function (done) {
            ...
            contextBrokerMock = nock(V2_BROKER)
                .put(
                    '/v2/entities/urn:ngsi-ld:TemperatureSensor:001/attrs/temperature',
                    utils.readExampleFile('./test/ngsi-v2/Property.json')
                )
                .reply(204);
    ...
    describe('When a normalized relationship is overwritten by name', function () {
        beforeEach(function (done) {
            ...
            contextBrokerMock = nock(V2_BROKER)
                .put(
                    '/v2/entities/urn:ngsi-ld:TemperatureSensor:001/attrs/controlledAsset',
                    utils.readExampleFile('./test/ngsi-v2/Relationship.json')
                )
                .reply(204);
