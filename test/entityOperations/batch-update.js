...
describe('Batch Update Entities', function () {
    ...
    const options = {
        method: 'POST',
        url: LEPUS_URL + 'entityOperations/update'
    };
    const ORION_ENDPOINT = '/v2/op/update/';

    describe('When multiple normalized entities are updated', function () {
        beforeEach(function (done) {
            options.json = utils.readExampleFile('./test/ngsi-ld/Batch-Update-Entities.json');
            contextBrokerMock = nock(V2_BROKER)
                .post(ORION_ENDPOINT, utils.readExampleFile('./test/ngsi-v2/Batch-Update-Entities.json'))
                .reply(201);
